package com.shx.web.utils.page;
...
public class SpringContextHolder implements ApplicationContextAware{
    ...
    /**
     * 根据Bean的名称从Spring容器中获取Bean对象。<br/> 
     * 详细描述：根据Bean的名称从Spring容器中获取Bean对象。<br/> 
    ...
    /**
     * 根据Class从Spring容器中获取Bean对象。<br/> 
     * 详细描述：根据Class从Spring容器中获取Bean。<br/> 
     * 使用方式：java代码中可直接调用此静态方法。
    ...
    /**
     * 根据Bean名称、Class从Spring容器中获取Bean对象。<br/> 
     * 详细描述：根据Bean名称和Class从Spring容器中获取Bean对象。<br/> 
     * 使用方式：java代码中可直接调用此静态方法。
     * @param name bean名称。
     * @param clazz Class实例。
     * @return T 返回相应的bean对象。
    ...
    /**
     * 获取Spring容器中的BeanDefinition Map。<br/> 
     * 详细描述：获取Spring容器中的BeanDefinition Map。<br/> 
     * 使用方式：java代码中可直接调用此方法。
